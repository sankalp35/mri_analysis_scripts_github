...
drn_mask_hailey = {
    ...
    'copes_of_interest': [14, 15, 27, 28, 29, 30],
    'resolution': '1mm'
}

drn_mask_hailey_cropped = {
    'name': 'drn_mask_hailey_cropped_1mm',
    'path': dataDir + '/masks/drn_mask_hailey_cropped_1mm',
    'copes_of_interest': [14, 15, 27, 28, 29, 30],
    'resolution': '1mm'
}
...
sn_mask_hailey = {
    ...
    'copes_of_interest': [14, 15, 27, 28, 29, 30, 6, 18],
    'resolution': '1mm'
}
...
sgACC_mask_sankalp = {
    'name': 'sgACC_mask_sankalp',
    'path': dataDir + '/masks/sgACC_mask_sankalp',
    'copes_of_interest': [9],
    'resolution': '1mm'
}

all_masks = [drn_mask_hailey, drn_mask_hailey_cropped, hypothalamus_mask_daria, anterior_insula_mask_hailey, sn_mask_hailey, vta_mask_hailey, sgACC_mask_sankalp]
